...
public class ErrorCodeConstants {
    ...
    public static final String ITEM_CATEGORY_HAS_ACTIVE_ITEM_CODE = "item_category_has_active_item";
    public static final String ITEM_CATEGORY_HAS_ACTIVE_ITEM_MESSAGE = "Item category has active item";
